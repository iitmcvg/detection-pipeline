# TensorFlow-Layers image classification model library

# Directory Descriptions

* protos: contain configuration proto buf's
* builders: build Protos
* core: contain functions referred to by builders
* nets: contain deployment networks.
* preprocessing: preprocessing to perform.
